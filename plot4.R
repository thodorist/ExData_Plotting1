...
#### remove the borders of the legend       ####
#### in "Energy sub metering" plot, we used ####
#### option bty = "n" in legend command.    ####
################################################
png("plot4.png", width=480, height=480)
par(mfrow = c(2, 2))
with(subsetDATA, {
  plot(Time, subsetDATA[, 3], type = 'l', xlab = "", ylab = "Global Active Power")
  plot(Time, subsetDATA[, 5], type = 'l', xlab = "datetime", ylab = "Voltage")
  ...
  plot(Time, subsetDATA[, 4], type = 'l', xlab = "datetime", ylab = "Global_reactive_power")
  })
dev.off()